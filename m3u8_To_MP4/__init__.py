...
def async_download(m3u8_uri, customized_http_header=None, max_retry_times=3,
    ...
    with v2_async_processor.AsynchronousUriCrawler(m3u8_uri,
...
def async_file_download(m3u8_uri, m3u8_file_path, customized_http_header=None,
                        ...
                        tmpdir=None):
    with v2_async_processor.AsynchronousFileCrawler(m3u8_uri,
																m3u8_file_path,
																customized_http_header,
																max_retry_times,
																num_concurrent,
...
def multithread_download(m3u8_uri, customized_http_header=None,
    ...
    :return:
    '''
    with v2_multithreads_processor.MultiThreadsUriCrawler(m3u8_uri,
																	  customized_http_header,
																	  max_retry_times,
																	  max_num_workers,
																	  mp4_file_dir,
...
def multithread_file_download(m3u8_uri, m3u8_file_path,
                              ...
                              mp4_file_name='m3u8_To_MP4', tmpdir=None):
    with v2_multithreads_processor.MultiThreadsFileCrawler(
